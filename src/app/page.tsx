      ...
      <div className="px-6 pb-8">
        ...
        <div className="bg-white rounded-2xl shadow-md p-5">
          ...
          <button
            type="button"
            onClick={async () => {
              notify("Redirecting to Google Sign-In…");
              await supabase.auth.signInWithOAuth({ provider: 'google' });
            }}
            className="w-full py-3 rounded-xl border border-slate-300 font-bold text-slate-700 hover:bg-slate-50 flex items-center justify-center gap-2 transition shadow-xs text-sm"
          >
